...
static volatile int32_t engineRPM = 0;
static volatile int32_t engineFrequency = 0;           // in Hz
static volatile EngineRPMState_t rpmState = RPM_STATE_CONSTANT;
...
void checkRPMstate() {
  static int32_t prevRPM = 0;
  int32_t actualRPM = getEngineRPM();
